...
export const SpreadsheetIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        d="M14 4.5V14C14 14.5304 13.7893 15.0391 13.4142 15.4142C13.0391 15.7893 12.5304 16 12 16H4C3.46957 16 2.96086 15.7893 2.58579 15.4142C2.21071 15.0391 2 14.5304 2 14V2C2 1.46957 2.21071 0.960859 2.58579 0.585786C2.96086 0.210714 3.46957 0 4 0H9.5L14 4.5Z"
        fill="currentColor"
        opacity="0.2"
      />
      <path
        ...
        strokeWidth="1"
      />
      <path d="M9.5 0V4.5H14" stroke="currentColor" strokeWidth="1" />
      <path d="M4.5 7.5H11.5" stroke="currentColor" strokeWidth="0.75" />
      <path d="M4.5 9.5H11.5" stroke="currentColor" strokeWidth="0.75" />
      <path d="M4.5 11.5H11.5" stroke="currentColor" strokeWidth="0.75" />
      <path d="M6.5 7.5V12.5" stroke="currentColor" strokeWidth="0.75" />
      <path d="M9.5 7.5V12.5" stroke="currentColor" strokeWidth="0.75" />
    </svg>
  );
};
